...
public class CommentAdapterActivity extends RecyclerView.Adapter<CommentAdapterActivity.CommentViewHolder> {
    ...
    public CommentAdapterActivity(Context mContext, List<Comment> mData,String postKey) {
    ...
    public void onBindViewHolder(@NonNull final CommentViewHolder holder, int position) {
        ...
        holder.post_id.setText(postKey);
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    ...
                                    case R.id.delete:
                                        ...
                                        DatabaseReference deleteComment = FirebaseDatabase.getInstance().getReference().child("PostComments").child(holder.post_id.getText().toString()).child(holder.ID.getText().toString());
        ...
        holder.lyaout_Like.setVisibility(View.VISIBLE);
    ...
    public class CommentViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView tv_name,tv_content,tv_date,tv_commentnum,tv_likenum,post_id,user_id;
        TextView pdf_name,pdf_size,seen_num,sound_name,sound_size,sound_finalText,sound_startText;
        LinearLayout pdf_shower,sound_shower,lyaout_Like;
        ...
        public CommentViewHolder(View itemView) {
            ...
            post_id=itemView.findViewById(R.id.comment_id);
            ...
            lyaout_Like=itemView.findViewById(R.id.lyaout_Like);
